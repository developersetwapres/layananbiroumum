                        ...
                        <div className="space-y-3">
                            {filteredRequests.length === 0 ? (
                                <Card>
                                    <CardContent className="p-8 text-center">
                                        <p className="text-gray-500">
                                            Tidak ada riwayat permintaan yang
                                            ditemukan
                                        </p>
                                    </CardContent>
                                </Card>
                                ...
                                filteredRequests.map((request: any) => (
                                    <Card
                                        key={request.code}
                                        className="gap-0 py-2 transition-shadow hover:shadow-md"
                                    >
                    ...
                    <DialogContent className="max-h-[90vh] overflow-y-auto px-10 pt-12 sm:max-w-2xl">
                        ...
                        {selectedRequest && (
                            <div className="space-y-6">
                                            ...
                                            <>
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-gray-600">
                                                            {
                                                                selectedRequest.jenis_rapat
                                                            }
                                                        </p>
                                                    </div>
                                                </div>

                                                {kebutuhanDanDukungan.map(
                                                    (need: any, index: any) => {
                                ...
                                {/* Photos Section */}
                                {selectedRequest.id === 'damage' &&
                                    selectedRequest.picture.length > 0 && (
                                        <div>
                                            <p className="mb-3 font-medium text-gray-900">
                                                Foto Kerusakan (
                                                {selectedRequest.picture.length}
                                                )
                                            </p>
                                            <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
                                                {selectedRequest.picture.map(
                                                    (
                                                        photo: string,
                                                        index: number,
                                                    ) => (
                                ...
                                {selectedRequest.keterangan &&
                                    ...
                                    (() => {
                                        ...
                                        const color =
                                            colorMap[selectedRequest.status] ??
                                            colorMap['in_progress'];
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="mb-2 flex items-center gap-2">
                                                    ...
                                                    />
                                                    <h4
                                                        className={`font-medium ${color.title}`}
                                                    >
                                                        Pesan dari Admin
                                                    </h4>
                                                </div>
